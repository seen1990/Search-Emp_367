...
export default function Index({ employees, query }) { 
    ...
    //sortconfig ใช้เพื่อเก็บข้อมูลการเรียงลำดับ ส่วนฟังก์ชันsetSortConfig ใช้เพื่อเปลี่ยนคอลัมน์ที่ต้องการเรียงลำดับ
    ...
    //ฟังก์ชันgetArrowมีหน้าที่แสดงทิศทางลูกศร 
                            ...
                            {sortedEmployees.map((employee, index) => ( //แสดงข้อมูลพนักงานทั้งหมด
                                <tr key={employee.emp_no} style={{ backgroundColor: index % 2 === 0 ? '#f9f9f9' : '#fff' }}> 
                                    ...
                                    <td style={{ borderBottom: '1px solid #ddd', padding: '10px 20px', textAlign: 'center' }}>
                                        {new Date(employee.birth_date).toLocaleDateString('en-GB', { //แปลงวันที่เป็นรูปแบบของอังกฤษ dd/mm/yyyy
                                            day: '2-digit',
                                            month: '2-digit',
                                            year: 'numeric'
                                        })}
